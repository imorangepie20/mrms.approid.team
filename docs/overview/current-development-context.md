...
- 2026-09-23 GMS·Home·EMS의 재생 버튼 아이콘을 공통 `PlayIcon` SVG로 통일했다. CSS 삼각형을 제거하고 기존 aria-label·재생 동작은 유지했으며, 상세 결과는 `docs/changes/2026-09-23-play-icon-unification.md`에 기록했다.
