...
최신 Zorin Web 배포 기준 커밋: `f9443da` (EMS embedding image: `b91afce`)
...
- 2026-09-23 GMS·Home·EMS의 재생 버튼 아이콘을 공통 `PlayIcon` SVG와 `cover-play-button` 스타일로 통일했다. GMS 전용 Gateway 마크업에도 40px 원형·그림자·hover/focus·모바일 표시 규칙을 직접 연결했으며, 상세 결과는 `docs/changes/2026-09-23-play-icon-unification.md`에 기록했다.
